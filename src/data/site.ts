...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    location: "City, State",
    chapter:
      "Based in [city]. Currently [student / early-career / building full-time] — replace with a real life-stage line.",
    about:
      "Two or three paragraphs of room here. Who you are outside the commit log: how you got into this, what you’re trying to get better at, and what you care about on Resumurai. Write like a person, not a LinkedIn summary.",
    passions: ["Passion one", "Passion two", "Passion three"],
    resumuraiUrl: "https://www.resumurai.com",
